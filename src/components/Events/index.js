...
// class Events extends Component {
//   state = {
//     isEachEvent: 'CLICK_ON_EVENT',
//   }

//   onClickEachEvent = registrationStatus => {
//     this.setState({isEachEvent: registrationStatus})
//   }

//   render() {
//     const {isEachEvent} = this.state
//     return (
...
//               <EventItem
//                 eachItemList={eachObject}
//                 key={eachObject.id}
//                 onClickEachEvent={this.onClickEachEvent}
//               />
//             ))}
//           </ul>
//         </div>
//         <ActiveEventRegistrationDetails eventActive={isEachEvent} />
//       </div>
//     )
//   }
// }
